...
describe('WebhookSigner', () => {
  it('signs and rejects replayed or modified events', () => {
    ...
    const event = { id: 'evt_1', type: 'task.completed' as const, taskId: 'task_1', userId: 'user_1', timestamp: new Date(1000000).toISOString(), payload: { status: 'completed' }, delivery: { status: 'pending' as const, attempts: 0 } };
